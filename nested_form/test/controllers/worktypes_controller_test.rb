...
class WorktypesControllerTest < ActionController::TestCase
  ...
  test "should create worktype" do
    assert_difference('Worktype.count') do
      post :create, worktype: { begin_at: @worktype.begin_at, end_at: @worktype.end_at, name: @worktype.name, uid: @worktype.uid }
    end
  ...
  test "should update worktype" do
    patch :update, id: @worktype, worktype: { begin_at: @worktype.begin_at, end_at: @worktype.end_at, name: @worktype.name, uid: @worktype.uid }
    assert_redirected_to worktype_path(assigns(:worktype))
  end
